...
library StoredSize {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "StoredSize", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000053746f72656453697a65000000000000);
