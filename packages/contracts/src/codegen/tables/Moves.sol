...
library Moves {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Moves", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d6f7665730000000000000000000000);
