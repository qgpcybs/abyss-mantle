...
library RemovedCoord {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "RemovedCoord", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000052656d6f766564436f6f726400000000);
