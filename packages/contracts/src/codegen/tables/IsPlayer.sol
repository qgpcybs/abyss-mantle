...
library IsPlayer {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "IsPlayer", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004973506c617965720000000000000000);
