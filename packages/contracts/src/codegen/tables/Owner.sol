...
library Owner {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Owner", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004f776e65720000000000000000000000);
