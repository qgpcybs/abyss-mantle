...
library Creator {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Creator", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000043726561746f72000000000000000000);
