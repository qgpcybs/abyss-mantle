...
library Commander {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Commander", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000436f6d6d616e64657200000000000000);
