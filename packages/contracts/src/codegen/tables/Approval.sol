...
library Approval {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Approval", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000417070726f76616c0000000000000000);
